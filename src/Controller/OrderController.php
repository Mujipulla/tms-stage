    ...
    public function add(Cart $cart, Request $request): Response
    {
        ...
        if ($form -> isSubmitted() && $form -> isValid()) {
            ...
            foreach ($cart->getFull() as $product) {
                ...
                $orderDetails->setProduct($product['item']->getName());
                $orderDetails->setQuantity($product['quantity']);
                $orderDetails->setPrice($product['item']->getPrice());
                $orderDetails->setTotal($product['item']->getPrice() * $product['quantity']);
                $pdfname = $product['item']->getPdfname();
                if (!$pdfname->isEmpty()) {
                    $orderDetails->setPdfname($pdfname->first());
                }
